	...
	Describe(`Model constructor tests`, func() {
		Context(`Using a service client instance`, func() {
			...
			It(`Invoke NewCreateCredentialOptions successfully`, func() {
				...
				createCredentialOptionsModel := postureManagementService.NewCreateCredentialOptions(createCredentialOptionsEnabled, createCredentialOptionsType, createCredentialOptionsName, createCredentialOptionsDescription, createCredentialOptionsDisplayFields, createCredentialOptionsPurpose)
